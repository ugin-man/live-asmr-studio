...
**[Download Live ASMR Studio v0.15.1](https://github.com/ugin-man/live-asmr-studio/releases/latest/download/live-asmr-studio-v0.15.1.zip)**
...
1. Download [live-asmr-studio-v0.15.1.zip](https://github.com/ugin-man/live-asmr-studio/releases/latest/download/live-asmr-studio-v0.15.1.zip) from the latest GitHub release.
...
node scripts/test_audio_lifecycle.js
node scripts/test_settings.js
node scripts/test_motion_controls.js
...
The audio lifecycle tests run the real engine and worker with simulated Chrome/Web Audio hardware. They verify state and persistence; they do not replace a listening check in Chrome or Brave.
...
導入は、[最新版のZIP](https://github.com/ugin-man/live-asmr-studio/releases/latest/download/live-asmr-studio-v0.15.1.zip)をダウンロードして展開し、`chrome://extensions` または `brave://extensions` でデベロッパーモードを有効にして、その展開先を「パッケージ化されていない拡張機能」として読み込んでください。更新時は同じフォルダの中身を新しい版へ置き換え、拡張機能カードの「再読み込み」を押すだけです。使うときはChatGPT Voice Liveのタブを前面にして、ツールバーの拡張機能アイコンを押します。
